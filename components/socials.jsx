...
const Socials = (props) => {
    return (
        <div className='flex flex-row items-center'>
            <a href={`mailto:${props.data.email}?subject=[WORK]`} className='mr-10 transition-all bg-primary-300 hover:bg-primary-100 text-surface-100 font-bold py-2 px-2 rounded flex flex-row justify-center items-center'>
